...
const SQL_ADAPTER = class SQL_Adapter {
   ...
   * @param {Object|string} [options.population] Optional population configuration for documents returned in .load and .search queries (see sequelize include for proper formatting)
